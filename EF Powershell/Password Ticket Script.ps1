...
foreach ($obj in $table) {
    try { 
        ...
        Send-MailMessage -From 'Help Desk <helpdesk@springeq.com>' -To 'helpdesk@springeq.com' -Subject $subject -body $htmlbody -SmtpServer 'springeq-com.mail.protection.outlook.com' -UseSsl
        $obj.Ticket = 'T'
